...
import imageAppBanner from '../assets/downloadbanner_desktop_en4_8ba7cb6e33.png'
const Youtube = () => {
  return (
  ...
  <button className="mt-6 px-10 py-3 bg-white text-blue-500 font-bold rounded-full hover:bg-yellow-300 hover:text-white transition duration-300">
    MORE STORIES
        ...
        {/* Latest Draw Results Section */}
          {/* Latest Draw Results Section */}
          <div className="bg-gradient-to-r from-green-300 to-blue-500 rounded-lg p-5 text-white shadow-lg h-[480px] lg:w-[95%]">
...
<div className="mt-10">
  <a href="https://apps.apple.com/us/app/mahzooz/id1545182218"> <img src={imageAppBanner} alt="" className="m-auto rounded"/></a> 
</div>
      </div>
