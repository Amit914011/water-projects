    ...
    <div className="font-sans bg-white">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-12">
          ...
          {/* Right Side */}
          <div className="bg-gradient-to-b from-green-300 to-blue-300 p-4 md:p-6 lg:p-8 text-center w-full lg:w-auto rounded">
            {/* Timer Section */}
            <div className="flex  justify-center gap-4 text-blue-700 font-bold text-lg md:text-xl lg:text-2xl mb-4">
              {["Days", "Hours", "Mins", "Secs"].map((label, index) => (
                <div key={index} className="flex flex-col items-center bg-white w-[70px] h-[70px] justify-center   rounded-full">
                  <div className="text-2xl md:text-3 ">0</div>
                  <div className="text-[12px] -mt-2">{label}</div>
                </div>
              ))}
            </div>
