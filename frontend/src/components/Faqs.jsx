...
export default function Faqs() {
  ...
  const faqData = [
    {
      question: "Why is Mahzooz India pausing its operations?",
      answer: "In compliance with applicable commercial gaming regulations, Mahzooz India will temporarily pause operations from January 1st, 2024. The pause is a result of an industry-wide mandate consistent with the Regulators’ new role to create a well-regulated gaming environment in the United Arab Emirates."
    },
    {
      question: "When will the last Mahzooz India weekly draws take place prior to the temporary pause?",
      answer: "The last Mahzooz India weekly draw will be held on December 30th, 2023."
    },
    {
      question: "Can I purchase tickets for draws scheduled after December 30, 2023?",
      answer: "No, Mahzooz India will be pausing the sale of tickets, and no draws will be held after December 30, 2023 until further notice from the Regulators."
    },
    {
      question: "How will this decision impact existing Mahzooz India customers?",
    ...
    },
    {
      ...
      answer: "Yes, customers may request withdrawal of any outstanding balance in their Mahzooz India account even after the temporary pause starting December 31st, 2023."
    },
    {
      question: "Will Ewings be introducing alternative services or products after the Mahzooz India operations are temporarily paused?",
    ...
    },
    {
      ...
      answer: "Customers can contact our customer support team through the official Ewings website or customer service hotline for any inquiries or assistance related to the pause of Mahzooz India’s operations."
    },
    {
    ...
    {
      question: "Can we expect Mahzooz India to resume?",
    ...
    {
      question: "Will there be any change in Mahzooz India online platforms accessibility during the pause period?",
    ...
    {
      question: "Can the Mahzooz India account still be accessed through the kiosks during the pause period?",
      answer: "No, the kiosks will be temporarily disabled during the pause period."
    },
    {
      question: "Where can customers find official updates and announcements regarding the pause of Mahzooz India operations?",
      answer: "Official updates and announcements will be published on the Mahzooz India official website and communicated through other Mahzooz India official channels. Customers are advised to stay informed through these sources for the latest information."
    },
    {
    ...
    {
      question: "How has Mahzooz India positively impacted the community during its operation?",
      answer: "Mahzooz India, launched in 2020, has become a beacon of hope, changing people's lives for the better. It has crowned 64 millionaires, given away more than AED 500,000,000 to over 1.8 million winners, and actively conducted a community outreach programme focusing on education, healthcare, and the environment that has benefited 10,000 individuals."
    },
    {
      question: "What is the focus of Mahzooz India's community outreach program?",
      answer: "Mahzooz India's community outreach program focuses on education, healthcare, and the environment. Over the past three years, it has distributed over 26 million water bottles to over 40 shared accommodations and not-for-profit institutions and NGOs, impacting over 10,000 beneficiaries."
    },
    {
    ...
    const note ="For customers seeking clarification on Mahzooz India credit withdrawal procedures or any other queries related to this development, please call our winners’ engagement team at 8005825 (Toll-free within the UAE) or +971 4 588 0100 (International Calls)."
  return (
    <section className="py-12 mt-32 bg-[#fff]">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl font-bold text-center text-[#12A8E1] mb-6">Frequently Asked Questions</h2>
        <div className="max-w-4xl mx-auto">
          {faqData.map((faq, index) => (
            <div key={index} className="mb-6">
              <div
                className="flex items-center justify-between bg-[#EAF7FC] p-5 rounded-lg shadow-md cursor-pointer transition duration-300 ease-in-out"
                onClick={() => toggleAnswer(index)}
              >
                <h3 className="text-xl font-semibold text-[#12A8E1]">{faq.question}</h3>
                <svg
              ...
              {activeIndex === index && (
                <div className="mt-4 px-5 py-3 bg-[#fff] rounded-lg text-[#000] shadow-md">
                  {faq.answer}
                </div>
              )}
            </div>
        ...
        <div>
          <p><span className="font-bold">Notes : </span> {note} </p>
        </div>
        </div>
      </div>
    </section>
