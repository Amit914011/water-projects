...
const Footer = () => {
  return (
    <footer className="bg-blue-500 text-white text-base lg:text-lg font-bold">
      ...
      <div className="text-center py-6 text-sm font-normal">
        © MAHZOOZ 2024. LICENSE NO: CN-2965688. ALL RIGHTS RESERVED. <span>Developed by <a href="https://techxpert.in">techxpert</a></span>
      </div>
    </footer>
  );
};
